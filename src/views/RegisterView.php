            ...
            <div class="tab-content">
                ...
                <div role="tabpanel" class="tab-pane fade" id="categories">
                    ...
                    foreach($this->categories as $category) { ?>
                        <div class="checkbox">
                            <?php echo str_repeat('--', $category->getDepth() - 1); ?>
                            <label>
                                <input type="checkbox"> <?php echo $category->getName(); ?>
                            </label>
                        </div>
                    <?php } ?>
                    <div class="form-group">
                ...
                <nav class="center_div">
                    <ul class="pagination">
                        ...
                        <li aria-label="Next"><a href="#categories" aria-controls="categories" role="tab" data-toggle="tab">Categories</a></li>
                    </ul>
                </nav>
            </div>
        </div>
